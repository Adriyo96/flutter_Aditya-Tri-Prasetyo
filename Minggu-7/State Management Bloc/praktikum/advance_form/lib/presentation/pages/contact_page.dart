...
import 'package:advance_form/core/extensions/build_context_ext.dart';
...
import 'package:advance_form/presentation/pages/form_picker_page.dart';
            ...
            child: AlertDialog(
              ...
              actions: <Widget>[
                FozFormInput(
                  ...
                  validator: (value) => contactBloc.nameValidation(value!),
                ),
                16.0.height,
                FozFormInput(
                  label: 'Nomor',
                  ...
                  validator: (value) => contactBloc.phoneValidation(value!),
                ),
                16.0.height,
                Align(
                  ...
                  child: FozFormButton(
                    ...
                    onPressed: () {
                      ...
                      if (form.validate()) {
                        contactBloc.add(UpdateContact(query));
                  ...
                  BlocConsumer<ContactBloc, ContactState>(
                    listener: (context, state) {
                      if (state is ContactSError) {
                        context.errorDialog(message: state.error);
                      } else if (state is ContactSuccess) {
                        context.successDialog(message: state.message);
                      }
                    },
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                  ...
                                  child: Card(
                                    color:
                                        item.pickedColor ?? AppColors.cardColor,
                                    child: ListTile(
